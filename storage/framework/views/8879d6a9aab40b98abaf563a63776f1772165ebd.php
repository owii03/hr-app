					...
					<li>
						...
						<div class="tab-contenty animated fadeIn" id="tab-content1">
							<table class="qvstable">
								...
								<?php $__currentLoopData = $datacoding; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($d->category == 'Coding'): ?>
										<tr>
											<td><?php echo e($loop->iteration); ?></td>
											<td><?php echo e($d->question); ?></td>
											<td><?php echo e($d->answer); ?></td>
											<td><?php echo e($d->feedback); ?></td>
											<td><?php echo e($d->answer_a); ?></td>
											<td><?php echo e($d->answer_b); ?></td>
											<td><?php echo e($d->answer_c); ?></td>
											<td><?php echo e($d->answer_d); ?></td>
											<td><button data-category="Coding"  data-id="<?php echo e($d->id); ?>" class='edit btn btn-warning btn-sm'>Edit</button> <button data-id="<?php echo e($d->id); ?>" class='delete btn btn-success btn-sm'>Delete</button></td>
										</tr>
									<?php endif; ?>
					...
					<li>
						...
						<div class="tab-contenty animated fadeIn" id="tab-content2">
							<table class="qvstable">
								...
								<?php $__currentLoopData = $datadesign; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($d->category == 'Design'): ?>
										<tr>
											<td><?php echo e($loop->iteration); ?></td>
											<td><?php echo e($d->question); ?></td>
											<td><?php echo e($d->answer); ?></td>
											...
											<td><?php echo e($d->answer_c); ?></td>
											<td><?php echo e($d->answer_d); ?></td>
											<td><button data-category="Design" data-id="<?php echo e($d->id); ?>" class='edit btn btn-warning btn-sm'>Edit</button> <button data-id="<?php echo e($d->id); ?>" class='delete btn btn-success btn-sm'>Delete</button></td>
										</tr>
									<?php endif; ?>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					<li>
						...
						<div class="tab-contenty animated fadeIn" id="tab-content3">
							<table class="qvstable">
								...
								<?php $__currentLoopData = $dataqa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($d->category == 'QA'): ?>
										<tr>
											<td><?php echo e($loop->iteration); ?></td>
											<td><?php echo e($d->question); ?></td>
											<td><?php echo e($d->answer); ?></td>
											...
											<td><?php echo e($d->answer_c); ?></td>
											<td><?php echo e($d->answer_d); ?></td>
											<td><button data-category="QA"  data-id="<?php echo e($d->id); ?>" class='edit btn btn-warning btn-sm'>Edit</button> <button data-id="<?php echo e($d->id); ?>" class='delete btn btn-success btn-sm'>Delete</button></td>
										</tr>
									<?php endif; ?>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					<li>
						...
						<div class="tab-contenty animated fadeIn" id="tab-content4">
							<table class="qvstable">
								...
								<?php $__currentLoopData = $dataanalytic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($d->category == 'Analytic'): ?>
										<tr>
											<td><?php echo e($loop->iteration); ?></td>
											<td><?php echo e($d->question); ?></td>
											<td><?php echo e($d->answer); ?></td>
											...
											<td><?php echo e($d->answer_c); ?></td>
											<td><?php echo e($d->answer_d); ?></td>
											<td><button data-category="Analytic"  data-id="<?php echo e($d->id); ?>" class='edit btn btn-warning btn-sm'>Edit</button> <button data-id="<?php echo e($d->id); ?>" class='delete btn btn-success btn-sm'>Delete</button></td>
										</tr>
									<?php endif; ?>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				...
				<ul class="tabesi">
					<li>
						...
						<div class="tab-contenty2 animated fadeIn" id="tab-content1">
							...
							<?php $__currentLoopData = $datapracticecoding; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($d->category == 'Coding'): ?>
								<tr>
									<td><?php echo e($loop->iteration); ?></td>
									<td><a download href="<?php echo e(Url('practice')); ?>/<?php echo e($d->file); ?>"><?php echo e($d->file); ?></td>
					...
					<li>
						...
						<div class="tab-contenty2 animated fadeIn" id="tab-content2">
							<table class="qvstable2">
								...
								<?php $__currentLoopData = $datapracticedesign; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($d->category == 'Design'): ?>
									<tr>
										<td><?php echo e($loop->iteration); ?></td>
										<td><a download href="<?php echo e(Url('practice')); ?>/<?php echo e($d->file); ?>"><?php echo e($d->file); ?></td>
					...
					<li>
						...
						<div class="tab-contenty2 animated fadeIn" id="tab-content3">
							<table class="qvstable2">
								...
								<?php $__currentLoopData = $datapracticeqa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($d->category == 'QA'): ?>
									<tr>
										<td><?php echo e($loop->iteration); ?></td>
										<td><a download href="<?php echo e(Url('practice')); ?>/<?php echo e($d->file); ?>"><?php echo e($d->file); ?></td>
					...
					<li>
						...
						<div class="tab-contenty2 animated fadeIn" id="tab-content4">
							<table class="qvstable2">
								...
								<?php $__currentLoopData = $datapracticeanalytic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($d->category == 'Analytic'): ?>
									<tr>
										<td><?php echo e($loop->iteration); ?></td>
										<td><a download href="<?php echo e(Url('practice')); ?>/<?php echo e($d->file); ?>"><?php echo e($d->file); ?></td>
...
$(document).on("click", ".validate2", function() {
	...
	$.ajax({
	   url : '<?php echo e(Url("/doaddpractice")); ?>',
	   type : 'POST',
	   dataType: "json",
	   data : formData,
...
$(document).on("click", ".delete", function() {
	...
	if(confirm("Do you want to delete?")) {
	   ...
	   $.ajax({
	   url : '<?php echo e(Url("/dodeletetest")); ?>',
	   type : 'POST',
	   async :false,
	   data : {
		   _token:'<?php echo e(csrf_token()); ?>',

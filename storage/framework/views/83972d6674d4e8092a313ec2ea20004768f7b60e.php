      ...
      <div class="login-container-wrapper clearfix">
        ...
        <div class="tab-content">
          <div class="tab-pane" id="login">
            <form class="form-horizontal login-form" method="post" action="<?php echo e(Url('/dologin')); ?>">
		      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
              <div class="form-group relative">
                <input class="form-control input-lg" name="email" id="login_username" placeholder="E-mail Address" required="" value="<?php echo e(\Illuminate\Support\Facades\Cookie::get('cookie_laravel_email')); ?>" type="email">
                 </div>
              <div class="form-group relative">
             ...
             <div class="checkbox checkbox-success">
              ...
              <div class="text-center">
                <label><a href="<?php echo e(Url('/forgot')); ?>" class="forgotPass">Forgot your password?</a></label>
              </div>
            </form>
          </div>
          <div class="tab-pane active" id="sign_up">
            <form class="form-horizontal login-form" method="post" action="<?php echo e(Url('/doregister')); ?>">
			  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
              <div class="form-group relative">
              ...
              <hr>
              <div class="text-center">
                <label><a href="<?php echo e(Url('/login')); ?>" class="forgotPass">Already Member?</a></label>
              </div>
            </form>
          </div>
        </div>

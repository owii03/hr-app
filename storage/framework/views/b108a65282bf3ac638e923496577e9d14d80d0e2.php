<?php $__env->startSection('isi'); ?>
 ...
 <div class="contentArea2">
		<div class="wrapimage pulse">
			...
			<a href="<?php echo e(Url('/viewuserresult')); ?> " class="btn btn-success btn-lg btn-block2">View Result</a>
		</div>
		...
		<div class="container">
			...
			<div class="wizard">
				...
				<form role="form" enctype="multipart/form-data" name="cvForm2" id="cvForm2" action="<?php echo e(Url('/dofillcv')); ?>" method="post">
							...
							<div class="tab-pane active" role="tabpanel" id="step1">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<b>Email</b>
											<input id="mail" value="<?php echo e(Auth::user()->email); ?>" type="text" class="form-control input-lg" required="" readonly disabled></div>
									</div>
								</div>
								<div class="row">
				   ...
				   success : function(data) {
					   ...
					   {						   
						   for (var i = 0; i < grader.length; i++) {
							   ...
							   $.ajax({
								   url : '<?php echo e(Url("/dofilleducation")); ?>',
								   type : 'POST',
								   async :false,
								   data : formData,
								   processData: false,  // tell jQuery not to process the data

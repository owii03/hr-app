...
@section('isi')
  ...
  <div class="containerBoss">
    <form method="get" action="{{ Url('/applicantselection') }} ">
  ...
  <div class="boxCandidate">
    ...
    <div class="infoCandidate">
      <div class="namecan">
        <!--Ambil nama candidate--> {{ $m->full_name }}
      </div>
	  <?php
	  ...
	  @if($education)
        ...
        <span id="gelar" class="jawab">
          ...
          <!--Ambil gelar candidate-->{{ $education->grade }}
        </span>
        <br/>
        University
        <span id="kampus" class="jawab2">
          <!--Ambil gelar candidate-->{{ $education->name }}
        </span>
        <br/>
        Major
        <span id="jurusan" class="jawab3">
          <!--Ambil gelar candidate-->{{ $education->major }}
        </span>
        <br/>		
        GPA
        <span id="jipia" class="jawab4">
          <!--Ambil gelar candidate-->{{ $education->gpa }}
        </span>
	@endif
        <br/>
        TOEFL
        <span id="tupel" class="jawab5">
          <!--Ambil gelar candidate-->{{ $m->score }}
        </span>
        <br/>
	@if($work)
        Work
        <span id="kerja" class="jawab6">
          <!--Ambil gelar candidate-->{{ $work->position }}
        </span>
	...
	@endif
        ...
        <span id="fp" class="jawab7">
          <!--Ambil gelar candidate-->{{ $m->first_position }}
        </span>
        <br/>		
        Second Priority
        <span id="sp" class="jawab8">
          <!--Ambil gelar candidate-->{{ $m->second_position }}
        </span>
        <br/>		
      </div>

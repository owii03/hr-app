				...
				@if(Auth::user()->role == 'Member')
					<li class="mr70">
						<a class='<?php if(isset($selected) && $selected == 'Fill CV')
							echo 'active';?>' href="{{ Url('/fillcv') }}">FILL CV</a>
					</li>
					<li class="mr70">
						<a class='<?php if(isset($selected) && $selected == 'View CV')
							echo 'active';?>' href="{{ Url('/viewcv') }}">VIEW CV</a>
					</li>
					<li class="mr70">
						<a class='<?php if(isset($selected) && $selected == 'Online Test')
							echo 'active';?>' href="{{ Url('/onlinetest') }}">ONLINE TEST</a>
					</li>
				@else
					<li class="mr70">
						<a class="<?php if(isset($selected) && $selected == 'Applicant Selection')
							echo 'active';?>"
						href="{{ Url('/applicantselection') }}">APPLICANT SELECTION</a>
					</li>
					<li class="mr70">
						<a class="<?php if(isset($selected) && $selected == 'Selection Result')
							echo 'active';?>" href="{{ Url('/selectionresult') }}">SELECTION RESULT</a>
					</li>
					<li class="mr70">
						<a class="<?php if(isset($selected) && $selected == 'Modify Test')
							echo 'active';?>" href="{{ Url('/modifytest') }}">MODIFY TEST</a>
					</li>
				@endif
				<li class="mr70">
...
@if(Session::has('pesan'))
	<script type="text/javascript">
		//swal("Test", "Hello");
		swal("{{Session::get('title')}}", "{!!Session::get('pesan')!!}", "{{Session::get('alert')}}");
	</script>
@endif
</body>
